function xmoCalendar(options){
  ...
  _this.initTime = _this.dateToAry(options['initTime'] || _this.today);
  // 设定可用的时间范围
...
xmoCalendar.prototype.init_Event = function(){
  var _this = this;
  var lang = _this.lang[_this.lang_opt];
  $(_this.inputId).addClass('xmoCalendarInputSchedule').focusin(function(){
     _this.showCalendar();
  });
...
xmoCalendar.prototype.dateFormatToShow =  function(date,week){
  ...
  var lang = _this.lang[_this.lang_opt];
  var dateAry = _this.dateToAry(date);
  var monthIndex = parseInt(dateAry[1])-1;
...
xmoCalendar.prototype.getDataTable = function(year,month){
  var _this = this;
  var lang = _this.lang[_this.lang_opt];
  var year = parseInt(year || _this.currentFirstYear);
  var month = parseInt(month || _this.currentFirstMonth);
  var html = '';
