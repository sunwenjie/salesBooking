...
(function (BS) {
    BS.Ncity = function (option) {
        ...
        self.langs = {
            'tip_en': 'You Have Selected',
            'tip_ch': '您已经选中',
            'search_en': 'Search',
            'search_ch': '搜索',
            'selected_en': 'City(ies) / Country(ies)',
            'selected_ch': '个城市 / 海外国家',
            'china_en': 'China',
            'china_ch': '中国',
            'foreign_en': 'Overseas',
            'foreign_ch': '海外',
            ...
            'clear_en': 'Clear',
            'clear_ch': '清空',
            'one_en': 'First-tier City',
            'one_ch': '一线城市',
            'two_en': 'Second-tier City',
            'two_ch': '二线城市',
            'three_en': 'Third-tier City',
            'three_ch': '三线城市',
            'four_en': 'Fourth-tier City',
            'four_ch': '四线城市'
        };
